  ...
  return (
    <div>
      <div className="mt-4 mb-10">
        <h3 className="font-grifter font-bold text-[40px] xl:text-[48px] 2xl:text-[55px] leading-[114.84px] text-[#061F25]">
          Privacy Policy
        </h3>
        <p className="font-inter font-medium text-[18px] md:text-[16px] lg:text-[18px] xl:text-[22px] leading-[49px] text-[#282828]">
      ...
      <div>
        ...
        <ol className="list-alpha">
          <li>
            <h6 className="font-grifter font-bold text-[26px] leading-[49px] text-[#282828]">
              a. Information You Provide Us
            </h6>
            <p className="mb-10 font-inter font-medium text-[18px] md:text-[16px] lg:text-[18px] xl:text-[22px] leading-[49px] text-[#282828]">
