        ...
        <div className="container mx-auto px-8 mt-[66px] md:mt-[76px] lg:mt-[100px] xll:px-8 2xl:px-0 flex xl:mt-[133px] relative">
          ...
          <div className='bg-[#060e16] rounded-[50px] px-[40px] md:px-[60px] xl:px-[80px] shadow-about-sh z-10'>
            ...
            <div className='flex items-center justify-center flex-col mt-[46.66px] mb-[35px] md:mb-[40px] lg:my-[60px] xl:mt-[86px] xl:mb-[76px]'>
              <img src="/images/mobiholder-logo.png" alt="mobiholder-logo" className='max-w-[66px] max-h-[55.32px] mb-[20px]'/>
              <h3 className={`text-white font-grifter font-bold text-center text-[40px] leading-[60px]
                md:text-[50px] md:leading-[70px]
                lg:text-[60px] lg:leading-[80px]
                xl:text-[70px] xl:leading-[90px] `}>Access to Top Notch <br />Managerial Control </h3>
              <p className={`text-[#cccccc] font-inter font-medium text-center text-[16px] leading-[25px]
                md:leading-[32px]
                xl:text-[22px] xl:leading-[49px]`}>Do more with Mobiholder, manage your Events, IDs, subscriptions <br />and memberships with one app.</p>
            </div>
 
            {/* Buttons */}
            <div className={`bg-[#fefefe] rounded-[40px] mb-[41px] md:mb-[51px] lg:mb-[80-px] xl:mb-[82px] p-[8px] flex justify-between`}>
                ...
                about.id === selectedAbout && (
                  <div key={about.id}>
                    ...
                    <div className={`grid grid-cols-1 gap-[20px]
                      ...
                      <div>
                        <h3 className={`font-grifter font-bold text-[40px] text-center leading-[60px] bg-about-text-gradient bg-clip-text text-transparent
                          md:mb-[20px]       
                          lg:text-left                
                          xl:text-[53px] xl:leading-[70px] `}>{about.type}</h3>
                        <p className='font-grifter font-medium text-[16px] text-center lg:text-left leading-[30px] xl:text-[20px] xl:leading-[49px] text-[#a3a2a2]'>{about.desc}</p>
                      </div>
                      ...
                      <div className={`grid grid-cols-1  h-[640px] gap-[10px] border-t border-[#303031] mb-[30px] relative
                        ...
                        >
                          <div className='xl:pr-[30px] w-[55%] lg:w-full'>
                            <h4 className='font-grifter font-bold text[28px] leading-[35px] xl:text-[32px] xl:leading-[45px] text-[#fefefe] mb-[20px]'>{feature.title}</h4>
                            <p className='font-inter font-medium text-[18px] xl:text-[22px] leading-[32px] xl:leading-[49px] text-[#a3a2a2] mb-[20px]'>{feature.desc}</p>
                          </div>
                        </div>
                      ))}
                    </div>
