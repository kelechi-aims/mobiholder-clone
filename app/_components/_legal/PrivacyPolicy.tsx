  ...
  return (
    <div>
      <div className="mt-4 mb-10">
        <h3 className="font-grifter font-bold text-[24px] md:text-10 xl:text-[48px] 2xl:text-[55px] leading-15 md:leading-[114.84px] text-[#061F25]">
          Privacy Policy
        </h3>
        <p className="font-inter font-medium text-[14px] md:text-[16px] lg:text-[18px] xl:text-[22px] leading-12.25 text-[#282828]">
      ...
      <div>
        <h3 className="font-grifter font-bold text-[20px] xl:text-[48px] 2xl:text-[55px] leading-10 md:leading-[114.84px] text-[#061F25]">
          INFORMATION WE COLLECT
        </h3>
        <ol className="list-alpha">
          <li>
            <h6 className="font-grifter font-bold text-[16px] leading-12.25 text-[#282828]">
              a. Information You Provide Us
            </h6>
            <p className="mb-10 font-inter font-medium text-sm md:text-[16px] lg:text-[18px] xl:text-[22px] leading-12.25 text-[#282828]">
          ...
          <li>
            ...
            <p className="font-inter font-medium text-sm md:text-[16px] lg:text-[18px] xl:text-[22px] leading-12.25 text-[#282828]">
              Amet minim mollit non deserunt ullamco est sit aliqua dolor do
              amet sint. Velit officia consequat duis enim velit mollit.
              Exercitation veniam consequat sunt nostrud amet.Amet minim mollit
              non deserunt ullamco est sit aliqua dolor do amet sint. Velit
