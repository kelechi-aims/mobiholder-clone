...
import { orgMembers } from "@/app/_lib/data1";
...
const OrgMemberChart = () => {
  return (
    <div className="rounded-[17px] border border-[#343b4f] p-4">
...
const OrgThirdComponent = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[60%_1fr] gap-6 pt-8">
      <div className="rounded-xl border border-[#343b4f] ">
        <DashboardTable
          title="New Members"
