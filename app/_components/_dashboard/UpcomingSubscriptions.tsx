      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-2">
            <button className="p-1 rounded-sm bg-[#6c6d6e] text-white">
              <MdFilterList />
            </button>
            <button className="flex gap-1 justify-between items-center bg-[#0a1330] px-3 py-1 text-xs text-[#aeb9e1] rounded-md border border-[#0b1739] outline-none">
