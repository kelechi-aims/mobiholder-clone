...
import { recentIds, upcomingEvents } from "@/app/_lib/data1";
...
interface DashboardTableProps {
  ...
  onPrimaryClick: () => void;
  tableHeaders: { label: string; key: string | undefined }[];
  tableData: {
...
export const DashboardTable: FC<DashboardTableProps> = ({
  ...
  return (
    <div className="lg:col-span-2 p-px rounded-xl w-full">
      <div className="rounded-xl p-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-2">
            <button className="px-2 rounded-sm bg-[#6c6d6e] text-white">
              <MdFilterList />
            </button>
            <button className="flex items-center gap-2 text-white text-xs bg-indigo-950 px-3 py-2 rounded-sm hover:bg-gray-800">
              Export Data <FaArrowDown />
            </button>
            <button
              onClick={onPrimaryClick}
              className="flex items-center gap-2 text-white text-xs bg-purple px-3 py-1 rounded-sm hover:bg-[#8a1fbf]"
            >
              {primaryButtonLabel} {primaryButtonIcon}
            </button>
          </div>
        </div>
...
export const DashboardWidgets: FC = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="rounded-xl p-4">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex gap-2">
              ...
              <button className="flex items-center gap-2 text-white text-xs bg-purple px-3 py-1 rounded-sm hover:bg-[#8a1fbf]">
                Create New ID
              </button>
            </div>
          </div>
      ...
      {/* Upcoming Events */}
      <div className="p-px rounded-[17px] border border-[#343b4f]">
        <div className=" rounded-xl p-4">
